...
const unsigned char  AmstradFont[] PROGMEM = {
    ...
    0x3e, 0x7f, 0x51, 0x49, 0x45, 0x7f, 0x3e, 0x00, 
    0x00, 0x40, 0x42, 0x7f, 0x7f, 0x40, 0x40, 0x00, 
    0x00, 0x72, 0x7b, 0x49, 0x49, 0x6f, 0x66, 0x00, 
    ...
    0x61, 0x73, 0x1e, 0x0c, 0x1e, 0x73, 0x61, 0x00, 
...
void SSD1306_Mini::printChar( char ch ){
    ...
    data[0]= getFlash(AmstradFont, i*8 );
    data[1]= getFlash(AmstradFont, i*8 + 1);
    data[2]= getFlash(AmstradFont, i*8 + 2);
    data[3]= getFlash(AmstradFont, i*8 + 3);
    data[4]= getFlash(AmstradFont, i*8 + 4);    
    data[5]= getFlash(AmstradFont, i*8 + 5);    
    data[6]= getFlash(AmstradFont, i*8 + 6);    
    data[7]= getFlash(AmstradFont, i*8 + 7);    
